...
(function ( document, ArrayProto, undefined ) {
  ...
  function _activateGallery() {
    //If tabindex is defined, then enable gallery activation! In a hurry, test later
    gallery.tabIndex !== -1 && ( ag.dom.galleryActivated = false );
    
    document.documentElement.addEventListener( 'click', function ( event ) {
      ag.dom.galleryActivated = ( document.activeElement === gallery );
    });
  }
